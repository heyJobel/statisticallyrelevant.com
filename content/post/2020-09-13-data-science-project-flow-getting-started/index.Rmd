...
I recommend that you check out my other blog posts on the [best places to find data](/post/finding-data/) and [setting achievable goals](/post/setting-goals/) if you'd like to go into more detail on these parts of the process.
